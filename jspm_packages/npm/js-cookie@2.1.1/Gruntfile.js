...
(function(process) {
  ...
  module.exports = function(grunt) {
    ...
    grunt.initConfig({
      ...
      uglify: {
        options: {banner: '/*! <%= pkg.name %> v<%= pkg.version %> | <%= pkg.license %> */\n'},
        build: {files: {'build/js.cookie-<%= pkg.version %>.min.js': 'src/js.cookie.js'}}
      },
      watch: {
      ...
      compare_size: {
        ...
        options: {compress: {gz: function(fileContents) {
