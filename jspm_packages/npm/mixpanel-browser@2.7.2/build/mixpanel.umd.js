...
(function(process) {
  (function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.mixpanel = factory();
  }(this, function() {
    'use strict';
    ...
    var RESERVED_PROPERTIES = [SET_QUEUE_KEY, SET_ONCE_QUEUE_KEY, ADD_QUEUE_KEY, APPEND_QUEUE_KEY, UNION_QUEUE_KEY, PEOPLE_DISTINCT_ID_KEY, ALIAS_ID_KEY, CAMPAIGN_IDS_KEY, EVENT_TIMERS_KEY];
        ...
        for (var i = 0; i < tokens.length; i++) {
          ...
          if (token.indexOf('.') > -1) {
            ...
            for (var k = 0; k < found.length; k++) {
              if (found[k].className && _.isString(found[k].className) && hasClass(found[k], className)) {
    ...
    MixpanelPersistence.prototype._expire_notification_campaigns = _.safewrap(function() {
      var campaigns_shown = this['props'][CAMPAIGN_IDS_KEY],
          EXPIRY_TIME = DEBUG ? 60 * 1000 : 60 * 60 * 1000;
      if (!campaigns_shown) {
        return;
      }
    ...
    MPNotif.prototype._init_styles = function() {
      ...
      notif_media_queries['@media only screen and (max-width: ' + (min_width - 1) + 'px)'] = {'#overlay': {'display': 'none'}};
      var notif_styles = {
        ...
        '#bg.visible': {'opacity': MPNotif.BG_OPACITY},
        '.mini #bg': {
          'width': '0',
          'height': '0',
          'min-width': '0'
        ...
        '#thumbspacer': {'height': MPNotif.THUMB_OFFSET + 'px'},
        '#thumbborder-wrapper': {
          'position': 'absolute',
    ...
    MPNotif.prototype._yt_video_ready = _.safewrap(function() {
      ...
      new window['YT']['Player'](MPNotif.MARKUP_PREFIX + '-video-frame', {'events': {'onReady': function(event) {
