...
function chromeReleaseTest(){
    ...
    return new Promise((resolve, reject)=>{
        ...
        //run tet
        testLibs.chromeReleaseTest(driver).then((reportObj)=>resolve(reportObj));
        //get inpect-logs
...
function firefoxStylebookBug(){
    ...
    return new Promise((resolve, reject)=>{
        ...
        // let driver = new webdriver.withCapabilities(sessionConfig.caps).build();
        ...
        //run test
        testLibs.firefoxStylebookBug(driver).then((reportObj)=>resolve(reportObj));
        //quit
        driver.quit();
    });
}
